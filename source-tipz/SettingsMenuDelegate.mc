...
// Garmin-Connect-Mobile settings in resources-tipz/properties.xml — mode and target
// zone are editable here; FTP (a numeric value) is set in Garmin Connect Mobile.
